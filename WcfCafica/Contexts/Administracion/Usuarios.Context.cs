...
namespace WcfCafica.Contexts.Administracion
{
    ...
    public partial class UsuariosContext : DbContext
    {
        ...
        public static string GetConnectionString(string dbname)
        {
            ...
            //string connString = "metadata=res://*/Contexts.Usuarios.csdl|res://*/Contexts.Usuarios.ssdl|res://*/Contexts.Usuarios.msl;provider=MySql.Data.MySqlClient;provider connection string=\"server=10.10.1.72;user id={0};password={1};database=Usuarios\"";
            string connString = "metadata=res://*/Contexts.Administracion.Usuarios.csdl|res://*/Contexts.Administracion.Usuarios.ssdl|res://*/Contexts.Administracion.Usuarios.msl;provider=MySql.Data.MySqlClient;provider connection string=\"server={3};user id={0};password={1};database={2}\"";
    
            return String.Format(connString, user, password,dbname,servidor);
        }
        ...
        public virtual DbSet<VistasFiltrosReportes> VistasFiltrosReportes { get; set; }
